...
genelistOverlap <- function(list1,list2,backgroundTotal, print_result = TRUE, header = FALSE) {
  ...
  result[[1]]$percent_list2_background = (ngenes2/backgroundTotal)*100
  result[[1]]$percent_list1_background = (ngenes1/backgroundTotal)*100
